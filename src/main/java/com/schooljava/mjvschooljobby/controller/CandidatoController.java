...
public class CandidatoController {
    ...
    public CandidatoDto cadastrarCandidato (@RequestBody CandidatoDto candidatoDto){
        return candidatoService.cadastrarCandidato(candidatoDto);
    }

    @GetMapping ("/{id}")
    public Optional<CandidatoDto> buscarPorId(@PathVariable Integer id){
        return candidatoService.buscarPorId(id);
    }

    @PutMapping ("/{id}")
    public CandidatoDto alterarDados(@PathVariable Integer id, @RequestBody CandidatoDto candidatoDto){
        return candidatoService.alterarDados(id, candidatoDto);
    }
    @DeleteMapping ("/{id}")
